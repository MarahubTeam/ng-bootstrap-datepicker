...
export class DlDateTimePickerComponent<D> implements OnChanges, OnInit, ControlValueAccessor {
   ...
   */
  @Input()
  maxView: 'year' | 'month' | 'day' | 'hour' | 'minute'| string = 'year';
  /**
   ...
   */
  @Input()
  minView: 'year' | 'month' | 'day' | 'hour' | 'minute' | string = 'minute';
  /**
   ...
   */
  @Input()
  startView: 'year' | 'month' | 'day' | 'hour' | 'minute'| string = 'day';
